...
function HotelProcess() {
  ...
  const steps = [
    {
      number: "01",
      title: "Search Hotel",
      text: "Choose your destination, check-in date, check-out date and guests.",
      image: "/services/hotels/process/search-hotel.jpg",
      icon: Search,
    },
    {
      number: "02",
      title: "Choose Room",
      text: "Compare hotel rooms and select the best option for your stay.",
      image: "/services/hotels/process/choose-room.jpg",
      icon: BedDouble,
    },
    {
      number: "03",
      title: "Confirm Booking",
      text: "Review your booking details and confirm your hotel reservation.",
      image: "/services/hotels/process/confirm-booking.jpg",
      icon: CreditCard,
    },
    {
      number: "04",
      title: "Enjoy Your Stay",
      text: "Arrive at your hotel and enjoy a comfortable travel experience.",
      image: "/services/hotels/process/enjoy-stay.jpg",
      icon: Smile,
    },
  ];
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.utils.toArray(".hotel-process-card").forEach((card, index) => {
        gsap.fromTo(
          card,
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="hotel-process-heading text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-400 leading-7 text-lg">
            From searching hotels to enjoying your stay, we make hotel booking
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div
              key={step.number}
              className="hotel-process-card group relative rounded-[30px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl overflow-hidden hover:-translate-y-2 transition duration-500"
            >
