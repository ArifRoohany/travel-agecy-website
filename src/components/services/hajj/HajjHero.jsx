  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        <img
          src="/services/hajj/hajj-hero-bg.jpg"
          alt="Hajj and Umrah"
          className="hajj-hero-bg w-full h-full object-cover"
        />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24">
        <div className="max-w-3xl">
          <div className="hajj-hero-item inline-flex items-center gap-3 px-5 py-3 rounded-full bg-orange-100 dark:bg-orange-500/10 text-orange-500 font-black">
            <Building size={20} />
            HAJJ & UMRAH SERVICES
          </div>

          <h1 className="hajj-hero-item mt-7 text-5xl md:text-7xl font-black leading-tight text-slate-900 dark:text-white">
            Begin Your
            <br />
            Blessed Journey
            <br />
          ...
          <p className="hajj-hero-item mt-6 text-lg leading-8 text-slate-600 dark:text-slate-300 max-w-2xl">
            We provide complete Hajj and Umrah travel support including visa,
            flights, hotel booking, transport and guided assistance.
          </p>

          <div className="hajj-hero-item mt-8 flex flex-wrap gap-5">
            <Link
              to="/booking"
          ...
          <div className="hajj-hero-item mt-12 grid grid-cols-1 sm:grid-cols-3 gap-5">
