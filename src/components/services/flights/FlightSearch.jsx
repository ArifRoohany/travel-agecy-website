...
function FlightSearch() {
  ...
  const benefits = [
    ...
    { icon: WalletCards, title: "Best Flight Deals" },
    { icon: CheckCircle, title: "Instant Confirmation" },
    { icon: Headphones, title: "24/7 Travel Support" },
  ];

  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo(
        ".flight-search-animate",
        { opacity: 0, y: 45 },
        {
          opacity: 1,
          y: 0,
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-10 items-start">
        <div className="flight-search-animate rounded-[36px] bg-white dark:bg-slate-900 shadow-2xl border border-slate-100 dark:border-slate-800 p-6 md:p-8">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-400 leading-7">
            Search domestic and international flights with secure booking and
            fast confirmation.
          </p>
        ...
        <div className="flight-search-animate">
          <div className="relative overflow-hidden rounded-[36px] bg-[#000080] dark:bg-slate-900 shadow-2xl border border-[#000080]/20 dark:border-slate-800 p-8">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-white/80 leading-7">
                We help you find affordable flights with trusted airlines,
                secure payment and quick booking support.
              </p>
